...
function Coin(data){
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            case 38081: return multiHashing.cryptonight(convertedBlob, convertedBlob[0] >= 8 ? 9 : 4);       // MSR
    ...
    this.algoShortTypeStr = function(port, version) {
        switch (port) {
            ...
            case 38081: return version >= 8 ? "cn/half" : "cn/msr";        // MSR
    ...
    this.variantValue = function(port, version) {
        switch (port) {
            ...
            case 38081: return version >= 8 ? "half" : "msr";  // MSR
