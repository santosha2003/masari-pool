...
function Coin(data){
    ...
    this.cryptoNight = function(convertedBlob, port) {
        switch (port) {
            ...
            case 11898: return convertedBlob[0] >= 5 ? multiHashing.cryptonight_pico(convertedBlob, 0) : multiHashing.cryptonight_light(convertedBlob, 1); // TRTL
    ...
    this.algoShortTypeStr = function(port, version) {
        switch (port) {
            ...
            case 11898: return version >= 5 ? "cn-pico/trtl" : "cn-lite/1";     // TRTL
    ...
    this.variantValue = function(port, version) {
        switch (port) {
            ...
            case 11898: return version >= 5 ? "trtl" : "1";    // TRTL
