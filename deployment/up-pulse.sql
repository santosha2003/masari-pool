...
REPLACE INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pool', 'address_20393', '', 'string', 'ETNXP Address to mine to for 20393 (ETNXP) port.');
REPLACE INTO pool.config (module, item, item_value, item_type, Item_desc) VALUES ('pool', 'address, '', 'string', 'ETNXP Address to mine to for 20393 (ETNXP) port.');
